...
{
    public static SpotifyAlbumDto CreateSpotifyAlbumDto = new SpotifyAlbumDto
    {
        AlbumType = "album",
    ...
    internal static ArtistDto[] FakeArtists(int count)
    {
        var urlFaker = new Faker<ExternalUrlsDto>()
            .RuleFor(x => x.Spotify, x => $"https://open.spotify.com/artists/{RandomAlphaNumericString(14)}");

        var artistFaker = new Faker<ArtistDto>()
    ...
    internal static ItemDto[] FakeItems(int count)
    {
        var urlFaker = new Faker<ExternalUrlsDto>()
        ...
        var itemFaker = new Faker<ItemDto>()
    ...
    internal static ImageDto[] FakeImages(int count)
    {
        var imageFaker = new Faker<ImageDto>()
